...
#run in cmd using "python pyneww.py --input norm.jpg --prototxt deploy.prototxt --caffemodel hed_pretrained_bsds.caffemodel --width 720 --height 1080"
#change input path and programe path